 ...
 * Contains colors, typography, borders, and transitions
 */

// Theme configuration for the rental portal application
const theme = {
  colors: {
    primary: {
      50: "#EEF2FF",
  ...
  glassmorphism: {
    ...
    dark: "backdrop-filter: blur(8px); background-color: rgba(26, 32, 44, 0.8);",
  },
};
